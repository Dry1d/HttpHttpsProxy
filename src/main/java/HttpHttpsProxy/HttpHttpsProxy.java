...
// Main method for the program
    ...
    static HashMap<String, String> dontCache;
...
//                return true;
    ...
    static boolean dontCached(String urlStr) {
        if (dontCache.get(urlStr) != null) {
            log.add(log, dontCache.get(urlStr));
            return true;
        }
        return false;
    }
